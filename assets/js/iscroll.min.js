...
!(function (n, r, d) {
  var m =
    ...
    f = (function () {
      ...
      return (
        ...
        (e.offset = function (t) {
          for (t.offsetLeft, t.offsetTop; (t = t.offsetParent); )
  ...
  function t(t, i) {
    for (var s in ((this.wrapper =
      "string" == typeof t ? r.querySelector(t) : t),
    ...
    (this.translateZ =
      ...
      (this._events = {}),
      (this.scale = d.min(
        d.max(this.options.startZoom, this.options.zoomMin),
  ...
  function a(t, i) {
    for (var s in ((this.wrapper =
      "string" == typeof i.el ? r.querySelector(i.el) : i.el),
  ...
  (t.prototype = {
    ...
    _move: function (t) {
      if (
        ...
        ("pointermove" != t.type || t.isPrimary)
      ) {
            ...
            if (
              ...
              (this.currentPage = c),
                (a =
                  ...
                  d.max(
                    d.max(
                      d.min(d.abs(o - c.x), 1e3),
                      d.min(d.abs(n - c.y), 1e3)
                    ),
                    300
                  )),
                (o = c.x),
    ...
    getScrollerWidth: function () {
      return void 0 !== this.scrollerW
        ? this.scrollerW
        : this.scroller.offsetWidth;
    },
    getScrollerHeight: function () {
      return void 0 !== this.scrollerH
        ? this.scrollerH
    ...
    scrollTo: function (t, i, s, e) {
      if (0 != this.wrapperWidth && 0 != this.wrapperHeight) {
        if (s) {
          ...
          if (
            this.nextDisabled &&
            t == -(this.scrollerWidth - this.wrapperWidth)
          )
    ...
    scrollToElement: function (t, i, s, e, o) {
      if ((t = t.nodeType ? t : this.scroller.querySelector(t))) {
        ...
        !0 === s && (s = d.round(r.width / 2 - h.width / 2)),
          ...
          (i =
            null == i || "auto" === i
              ? d.max(d.abs(this.x - n.left), d.abs(this.y - n.top))
              : i),
    ...
    getComputedPosition: function () {
      ...
      return (
        (i = this.options.useTransform
          ? ((t = +(
              (s = s[f.style.transform].split(")")[0].split(", "))[12] || s[4]
            )),
            +(s[13] || s[5]))
    ...
    _zoomStart: function (t) {
      ...
      (this.touchesDistanceStart = d.sqrt(i * i + s * s)),
        ...
        (this.originX =
          d.abs(t.touches[0].pageX + t.touches[1].pageX) / 2 +
          this.wrapperOffset.left -
          this.x),
        (this.originY =
          d.abs(t.touches[0].pageY + t.touches[1].pageY) / 2 +
      ...
      if (this.enabled && f.eventType[t.type] === this.initiated) {
        ...
        (this.scaled = !0),
          h < this.options.zoomMin
            ? (h =
                0.5 * this.options.zoomMin * d.pow(2, h / this.options.zoomMin))
            : h > this.options.zoomMax &&
              (h =
                2 *
                this.options.zoomMax *
                d.pow(0.5, this.options.zoomMax / h)),
          (i = h / this.startScale),
    ...
    _zoomEnd: function (t) {
      ...
      this.enabled &&
        ...
        (this.x == i && this.y == s) ||
          this.scrollTo(i, s, this.options.bounceTime),
        (this.scaled = !1),
      ...
      (this.currentPage = {}),
          ...
          if (
            ...
            if (!0 === this.options.snap)
              ...
              for (t = (n = this.options.snap).length, i = -1; h < t; h++)
                (r = f.getRect(n[h])),
                  (0 === h || r.left <= f.getRect(n[h - 1]).left) &&
                    ((a = 0), i++),
        ...
        this.on("flick", function () {
          var t =
            ...
            d.max(
              d.max(
                d.min(d.abs(this.x - this.startX), 1e3),
                d.min(d.abs(this.y - this.startY), 1e3)
              ),
              300
            );
          this.goToPage(
    ...
    _nearestSnap: function (t, i) {
      ...
      var s = 0,
        ...
        o = 0;
      if (
        d.abs(t - this.absStartX) < this.snapThresholdX &&
        d.abs(i - this.absStartY) < this.snapThresholdY
      )
      ...
      (s =
        void 0 === s
          ? this.options.snapSpeed ||
            d.max(
              d.max(
                d.min(d.abs(o - this.x), 1e3),
                d.min(d.abs(n - this.y), 1e3)
              ),
              300
            )
          : s),
      ...
      if (this.enabled) {
        ...
        switch (
          ...
          (this.keyAcceleration =
            n - r < 200 ? d.min(this.keyAcceleration + 0.25, 50) : 0),
          t.keyCode)
        ) {
    ...
    (a.prototype = {
      ...
      updatePosition: function () {
        var t =
            (this.options.listenX &&
              d.round(this.sizeRatioX * this.scroller.x)) ||
            0,
          i =
            (this.options.listenY &&
              d.round(this.sizeRatioY * this.scroller.y)) ||
            0;
      ...
      _pos: function (t, i) {
        t < 0 ? (t = 0) : t > this.maxPosX && (t = this.maxPosX),
          ...
          (t = this.options.listenX
            ? d.round(t / this.sizeRatioX)
            : this.scroller.x),
          (i = this.options.listenY
            ? d.round(i / this.sizeRatioY)
            : this.scroller.y),
