...
(FLIPBOOK.Book3 = function (t, e, i) {
  ...
  e.on("toolMove", function () {
    ...
    this.scroll.on("zoomEnd", function () {
      if (isNaN(o.scroll.scale)) o.zoomTo(i.zoomMin);
        ...
        var t = i.main.zoom;
        (o.scroll.options.eventPassthrough = t > 1 ? "" : "vertical"),
          (o.scroll.options.freeScroll = t > 1),
          o.scroll.refresh();
      }
    }),
  ...
  var n,
    a = 3 * this.pageHeight + "px";
  (this.$centerContainer = jQuery("<div>")
    .appendTo(this.$wrapper)
    .addClass("flipbook-center-container3")),
    this.$centerContainer.css({ "-webkit-perspective": a, perspective: a }),
    ...
    (this.pagesArr = []),
    (this.animating = !1),
    this.setRightIndex(i.rightToLeft ? i.pages.length : 0),
    o.updateFlipped(),
    (this.numPages = i.pages.length);
  for (var h = 0; h < i.numPages; h++)
    (n = new FLIPBOOK.Page3(
      this,
      h,
      i.pages[h].src,
      i.pages[h].htmlContent
    )).hideHtml(),
      this.pagesArr.push(n),
      this.$centerContainer.append(n.$wrapper),
      this.flippedright++;
  this.pagesArr[0].show(),
    this.options.cover ||
      ((n = new FLIPBOOK.Page3(this, i.numPages, "", "")).hideHtml(),
      this.pagesArr.push(n),
      this.$centerContainer.append(n.$wrapper),
      this.flippedright++),
    (this.nextEnabled = !0),
  ...
  (FLIPBOOK.Book3.prototype.isZoomed = function () {
    return (
      this.options.main.zoom > this.options.zoomMin &&
      this.options.main.zoom > 1
    );
  }),
  (FLIPBOOK.Book3.prototype.onZoom = function () {}),
  (FLIPBOOK.Book3.prototype.getNumPages = function () {}),
  (FLIPBOOK.Book3.prototype.move = function (t) {
    if (!(this.zoom <= 1)) {
      var e = this.scroll;
      if (e) {
        var i = e.x,
        ...
        i > 0 && (i = 0),
          i < e.maxScrollX && (i = e.maxScrollX - 0),
          o > 0 && (o = 0),
          o < e.maxScrollY && (o = e.maxScrollY - 0),
          e.scrollTo(i, o, 0);
      }
    }
  }),
  (FLIPBOOK.Book3.prototype.zoomTo = function (t, e, i, o) {
    if (this.enabled) {
      (i = i || 0), (o = o || 0), (e = e || 0);
      (this.zoom = t), (e = 0);
      var s = this.scroll;
  ...
  (FLIPBOOK.Book3.prototype.updateBookPosition = function () {
    ...
    1 == this.view
      ...
      2 == this.view
        ? this.isCover()
          ? this.focusRight()
          : this.isBackCover() && this.options.cover
          ? this.focusLeft()
          : this.focusBoth()
        : 1 == this.view &&
          (this.isCover()
            ? this.focusRight()
            : this.isBackCover() && this.focusLeft());
  }),
  (FLIPBOOK.Book3.prototype.focusLeft = function (t, e) {
    var i =
      1 == this.view || this.options.singlePageMode ? 0 : this.pageWidth / 2;
    this.setBookPosition(i, t, e);
  }),
  (FLIPBOOK.Book3.prototype.focusRight = function (t, e) {
    var i =
      1 == this.view || this.options.singlePageMode
        ? -this.pageWidth
        : -this.pageWidth / 2;
    this.setBookPosition(i, t, e);
  }),
  ...
  (FLIPBOOK.Book3.prototype.setBookPosition = function (t, e, i) {
    if (this.centerContainerPosition != t) {
      ...
      if (e) {
          ...
          jQuery({ someValue: o })
            ...
            .animate(
              { someValue: t },
              {
                ...
                step: function (t) {
                  s._setStyle(
                    s.centerContainerStyle,
                    FLIPBOOK.IScroll.utils.style.transform,
                    "translateX(" + t + "px) translateZ(0)"
                  );
                },
                complete: function () {
        ...
        (this.centerContainerPosition = t),
          this._setStyle(
            this.centerContainerStyle,
            FLIPBOOK.IScroll.utils.style.transform,
            n
          ),
          this.updateFlipped(),
  ...
  (FLIPBOOK.Book3.prototype.updateVisiblePages = function (t) {
    ...
    var e = this,
      ...
      o = this.rightIndex;
    !this.options.backCover && this.options.rightToLeft && o--;
    for (var s = 0; s < this.pagesArr.length; s++)
      s == o || (s == o - 1 && !this.options.singlePageMode)
        ? this.pagesArr[s].show()
        : this.pagesArr[s].hide(),
        this.pagesArr[s]._setZIndex(0),
        this.pagesArr[s]._setStyle(this.pagesArr[s].wrapper.style, i, "");
    this.updateBookPosition();
    var n = this.pagesArr[o],
      a = this.pagesArr[o - 1],
      h = this.pagesArr[o + 1],
      r = this.pagesArr[o + 2],
      p = this.pagesArr[o - 2],
      l = this.pagesArr[o - 3];
    a
      ? (e.options.main.setLoadingProgress(0.1),
        a.load(function () {
          e.options.main.setLoadingProgress(1),
            a.showHtml(),
            n
              ? n.load(function () {
                  e.options.main.setLoadingProgress(1),
              ...
              : (p && p.load(null, !0), l && l.load(null, !0));
        }))
      : (e.options.main.setLoadingProgress(0.1),
        n.load(function () {
          e.options.main.setLoadingProgress(1),
    ...
    var g = this.options.rightToLeft ? -this.model.bookW : 0;
    this.scroll.scrollTo(g, 0, 300);
  }),
  ...
  (FLIPBOOK.Book3.prototype.prevPage = function () {
    if (this.prevEnabled)
      if (
        ...
        var t = this.options.singlePageMode
          ? this.rightIndex
          : this.rightIndex - 2;
        this.goToPage(t);
      } else {
  ...
  (FLIPBOOK.Book3.prototype.goToPage = function (t, e) {
    if (
      this.enabled &&
      !this.flipping &&
      ((this.options.singlePageMode || t % 2 != 0) && t--,
      t < 0 && (t = 0),
      t > this.options.pages.length && (t = this.options.pages.length),
      t != this.rightIndex)
    ) {
      if (e || this.options.instantFlip)
        return (
          this.setRightIndex(t),
          this.updateFlipped(),
      ...
      (this.goingToPage = t),
        t > this.rightIndex
          ? ((end = 180),
            (s.angle <= 0 || s.angle >= 180 || !s.angle) && (s.angle = 1))
          : t < this.rightIndex &&
            ((end = -180),
            (s.angle >= 0 || s.angle <= -180 || !s.angle) && (s.angle = -1)),
        this.options.singlePageMode && (o /= 2),
        jQuery({ someValue: s.angle }).animate(
          { someValue: end },
          {
            duration: o,
            easing: i,
  ...
  (FLIPBOOK.Book3.prototype.onSwipe = function (t, e, i, o, s, n, a) {
    if (
      !this.isZoomed() &&
      "flipbook-page-link" != t.target.className &&
      "start" != e &&
      "up" != i &&
      "down" != i &&
      !this.flipping
      ...
      "right" == i && (o *= -1);
      var h = (180 * o) / this.model.wrapperW;
      if (
        ("cancel" == e &&
          n <= 1 &&
          (h > 0 ? this.nextPage() : h < 0 && this.prevPage()),
        "end" == e &&
          n <= 1 &&
          (h > 0 ? this.nextPage() : h < 0 && this.prevPage()),
        "move" == e && n <= 1)
        ...
        if (h > 0) {
          ...
          if (
            this.options.singlePageMode &&
            this.rightIndex == this.pagesArr.length - 1
          )
            return;
          this.goingToPage = this.options.singlePageMode
            ? this.rightIndex + 1
            : this.rightIndex + 2;
        } else if (h < 0) {
        ...
        this.goingToPage != this.rightIndex &&
          this.goingToPage >= 0 &&
          this.goingToPage <= this.pagesArr.length &&
          (this.options.instantFlip || this._setPageAngle(h));
      }
    }
  }),
  ...
  (FLIPBOOK.Book3.prototype._setPageAngle = function (t) {
    var e, i, o, s;
    if (((this.angle = t), this.hideHtml(), this.options.singlePageMode))
      t > 0
        ? ((o = this.pagesArr[this.rightIndex])._setAngle(t / 2),
          (i = this.pagesArr[this.goingToPage]) && (i.show(), i.load()))
        : ((s = this.pagesArr[this.goingToPage]).show(),
          s.load(),
          s._setAngle(t / 2 + 90),
          (o = this.pagesArr[this.rightIndex]));
    else {
      var n = this.rightIndex,
        a = this.goingToPage;
      if (
        (this.options.rightToLeft && !this.options.backCover && (n--, a--),
        t > 0)
      ) {
        if (1 == this.view && this.isFocusedLeft()) return;
        (o = this.pagesArr[n]),
          (s = this.pagesArr[a - 1]),
          this.applyAngles(o, s, t, 90, 0),
          (i = this.pagesArr[a]),
          o.setShadowOpacity((t - 10) / 600),
          s.setShadowOpacity((180 - t - 10) / 600),
          s.load(),
          i && (i.show(), i.load());
      } else {
        if (1 == this.view && this.isFocusedRight()) return;
        (s = this.pagesArr[n - 1]),
          (o = this.pagesArr[a]).load(),
          this.applyAngles(o, s, t, -90, 180),
          o.setShadowOpacity((180 + t - 10) / 600),
          s.setShadowOpacity((-t - 10) / 600),
          (e = this.pagesArr[a - 1]) && (e.show(), e.load());
      }
    }
  }),
  ...
  (FLIPBOOK.Book3.prototype.applyAngles = function (t, e, i, o, s) {
    i < o
      ? (t && (t.show(), t._setAngle(i + s)), e && (e.hide(), e._setAngle(45)))
      : (e && (e.show(), e._setAngle(i + s)), t && (t.hide(), t._setAngle(45)));
  }),
  (FLIPBOOK.Book3.prototype.onPageUnloaded = function (t, e) {
    var i = t;
    this.options.rightToLeft && (i = this.options.pages.length - t - 1),
      this.pagesArr[i] && this.pagesArr[i].unload();
  }),
  (FLIPBOOK.Book3.prototype.onResize = function () {
    ...
    function c() {
      l.scroll && (l.scroll.options.zoomMin = l.ratio * p.zoomMin),
        l.scroll && (l.scroll.options.zoomMax = l.ratio * p.zoomMax),
        l.updateBookPosition(),
        l.scroll && l.scroll.zoom(l.ratio * p.main.zoom, e / 2, i / 2, 0);
    }
    Math.min(this.zoom, 1), Number(this.options.zoomMin);
    !this.options.singlePageMode &&
    this.options.responsiveView &&
    e <= this.options.responsiveViewTreshold &&
    h < 2 * r &&
    h < this.options.responsiveViewRatio
      ? ((this.view = 1), e / i > n / a ? g() : d())
      : ((this.view = 2), e / i >= o / s ? g() : d()),
      this.updateBookPosition(),
      this.updateFlipped(),
      this.options.main.turnPageComplete();
  }),
  (FLIPBOOK.Book3.prototype.isFocusedRight = function () {
    ...
    return this.options.singlePageMode
      ? this.rightIndex % 2 == 0
      : this.centerContainerPosition < t;
  }),
  ...
  (FLIPBOOK.Page3 = function (t, e, i, o) {
    (this.book = t),
      ...
      (this.$wrapper = jQuery("<div>")
        .addClass("flipbook-page3")
        .width(t.options.pageWidth)
        .height(t.options.pageHeight)),
      (this.wrapper = this.$wrapper[0]),
      (this.htmlContentScale = this.book.$wrapper.height() / 1e3);
    var s = t.options;
    (this.$inner = jQuery("<div>")
      .appendTo(this.$wrapper)
      .addClass("flipbook-page3-inner")),
      (this.$bg = jQuery("<div>")
        .appendTo(this.$inner)
        .addClass("flipbook-page3-bg")),
      (this.$html = jQuery("<div>")
        .appendTo(this.$inner)
        .addClass("flipbook-page3-html")
        .addClass("page_" + e)),
      (this.$html[0].style.width = (1e3 * s.pageWidth) / s.pageHeight + "px"),
      ...
      this.options.singlePageMode
        ? (this.$wrapper
            .css("left", String(this.book.options.pageWidth - 1) + "px")
            .addClass("flipbook-page3-front"),
          (this.type = "front"))
        : e % 2 == 0
        ? (this.$wrapper
            .css("left", String(this.book.options.pageWidth - 1) + "px")
  ...
  (FLIPBOOK.Page3.prototype = {
    load: function (t, e) {
      ...
      if (this.size >= i) t && t.call(this);
      else {
        this.size = i;
        var o = this,
          s = o.options.rightToLeft
            ? this.book.pagesArr.length - this.index - 1
            : this.index;
        this.options.main.loadPage(s, i, function (e) {
          if (e && e.image) {
            var i = e.image,
              n = (e.image.naturalHeight, e.image.naturalHeight);
            o.options.pageWidth, o.options.pageHeight;
            ("left" != o.options.pages[e.index].side &&
              "right" != o.options.pages[e.index].side) ||
              (o.index % 2 == 0 &&
                jQuery(i).css(
                  FLIPBOOK.IScroll.utils.style.transform,
                  "translateX(-50%) translateZ(0)"
                )),
              o.$bg.empty().append(jQuery(i)),
              o.$preloader.hide();
          }
          e &&
            e.canvas &&
            ...
            o.options.doublePage && o.index % 2 == 0 && 0 != o.index
              ? jQuery(e.rCanvas).appendTo(o.$bg)
              : o.options.doublePage &&
                o.index % 2 == 1 &&
                o.index != o.options.pages.length - 1
              ? jQuery(e.lCanvas).appendTo(o.$bg)
              : jQuery(e.canvas).appendTo(o.$bg),
            o.$preloader.hide()),
            o.options.main.loadPageHTML(s, function (t) {
              t &&
                (o.$html.empty().append(jQuery(t)),
                (o.$html[0].style.transform =
                  "scale(" + o.htmlContentScale + ") translateZ(0)")),
                o.options.doublePage &&
                  o.index % 2 == 0 &&
                  o.index > 0 &&
                  (o.$html[0].style.left = "-100%"),
                o.hidden && o.hideHtml();
            }),
            t && t.call(o);
        });
    ...
    unload: function () {
      (this.size = null), (this.mat = !1), (this.pageSize = null);
    },
    setMat: function (t, e, i) {},
    hideHtml: function () {
      this.$html && !this.htmlHidden && this.$html.hide(),
        (this.htmlHidden = !0);
    },
    showHtml: function () {
      this.$html && this.htmlHidden && this.$html.show(),
        (this.htmlHidden = !1);
    },
    ...
    show: function () {
      this.hidden &&
        ((this.$wrapper[0].style.display = "block"), this.setShadowOpacity(0)),
        (this.hidden = !1);
    },
    ...
    hide: function () {
      this.hidden ||
        ((this.$wrapper[0].style.display = "none"), this.setShadowOpacity(0)),
        (this.hidden = !0);
    },
    ...
    _setAngle: function (t) {
      if (this.angle != t) {
        ...
        var e,
          i,
          o = FLIPBOOK.IScroll.utils.style.transform,
          s = "translateZ(0)";
        "3d" == this.book.options.viewMode
          ? (e =
              "front" == this.type
                ? "rotateY(" + String(-t) + "deg) " + s
                : "rotateY(" + String(180 - t) + "deg) " + s)
          : "2d" == this.book.options.viewMode &&
            ("front" == this.type
              ? (t > 90 && (t = 90),
                (e = "scaleX(" + String((180 - 2 * t) / 180) + ") " + s))
              : (t < 90 && (t = 90),
                (e = "scaleX(" + String((2 * t) / 180 - 1) + ") " + s))),
          this._setStyle(this.wrapper.style, o, e);
        var n = 0;
        for (i = 0; i < this.book.pagesArr.length; i++)
          i != this.index &&
            this.book.pagesArr[i].zIndex > n &&
            (n = this.book.pagesArr[i].zIndex);
        this._setZIndex(n + 1);
      }
    },
